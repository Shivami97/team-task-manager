...
| :--- | :--- | :--- | :--- |
| **`admin@aether.com`** | `password123` | **ADMIN** | Full workspace authority (Create tasks, recruit members, delete projects). |
| **`member1@aether.com`** | `password123` | **MEMBER** | Standard team member (Can view boards, modify task status of assigned items). |
| **`member2@aether.com`** | `password123` | **MEMBER** | Standard team member (Can view boards, modify task status of assigned items). |
...
3. Railway will provision a high-performance database service instantly.

### 3. Deploy the Next.js Service
1. Click **New** -> **GitHub Repo** and select your pushed `team-task-manager` repository.
2. In the **Service Settings** under **Variables**, add the following:
